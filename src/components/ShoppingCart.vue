...
const props = defineProps(["isVisible", "ShoppingCart"]);
                ...
                <DialogPanel class="pointer-events-auto w-screen max-w-md">
                  <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div class="flex items-start justify-between">
                        ...
                        <div class="ml-3 flex h-7 items-center">
                          <button type="button" class="relative -m-2 p-2 text-gray-400 hover:text-gray-500" @click="$emit('toggleCart')">
                      ...
                      <div class="mt-8">
                        <div class="flow-root">
                          <ul role="list" class="-my-6 divide-y divide-gray-200">
                            <li v-for="(cart,index) in cartItems" :key="cart.id" class="flex py-6">
                              <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                <img :src="cart.thumbnail" :alt="cart.imageAlt" class="h-full w-full object-cover object-center" />
                              </div>
                              ...
                              <div class="ml-4 flex flex-1 flex-col">
                                <div>
                                  ...
                                  <p class="mt-1 text-sm text-gray-500">{{ cart.color }}</p>
                                </div>
                    ...
                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div class="mt-6">
                        <RouterLink  :to="{name:'checkout'}"  class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
