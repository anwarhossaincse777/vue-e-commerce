...
<template>
  <div class="container mx-auto py-10 px-10">
    ...
    <div class="h-1 bg-gray-700 w-52 mx-auto my-3"></div>

    <div class="grid grid-cols-3 gap-10 mt-10">
      <div class="bg-gray-800 text-center p-16 rounded-xl text-white">
        <svg
          class="fill-[#ffffff] h-14 mx-auto"
          version="1.1"
          id="Layer_1"
        ...
        <div class="">
          <h5 class="text-2xl font-bold mb-2">Fast Delivery</h5>
      ...
      <div class="bg-gray-800 text-center p-16 rounded-xl text-white">
        ...
        <div class="">
          <h5 class="text-2xl font-bold mb-2">Free Shiping</h5>
          <p>variations of passages of Lorem Ipsum available</p>
        </div>
      </div>
      ...
      <div class="bg-gray-800 text-center p-16 rounded-xl text-white">
        ...
        <div class="">
          <h5 class="text-2xl font-bold mb-2">Best Quality</h5>
          <p>variations of passages of Lorem Ipsum available</p>
        </div>
      </div>
    </div>
